...
const apiEmail = "gitdedi131@gmail.com"; // Ganti dengan email yang kalian gunakan
...
const KV_PROXY_URL = "https://raw.githubusercontent.com/FoolVPN-ID/ProxyV2/refs/heads/main/kvProxyList.json";
const PROXY_BANK_URL = "https://raw.githubusercontent.com/FoolVPN-ID/ProxyV2/refs/heads/main/proxyList.txt";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-gradient font-extrabold'>PROXYV2</span>");
